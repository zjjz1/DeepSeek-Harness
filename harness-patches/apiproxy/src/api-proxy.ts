...
const WEB_SETTINGS_NAMESPACES = [
  ...
  // Feature-owned preference namespaces added by this deployment's host
  // plugins (voice-input credentials, knowledge-base directories, team-mode
  // defaults). Each must be listed here or its writes are refused by the
  // configuration-client boundary below.
  'voice-input', 'knowledge-base', 'team-mode',
] as const
